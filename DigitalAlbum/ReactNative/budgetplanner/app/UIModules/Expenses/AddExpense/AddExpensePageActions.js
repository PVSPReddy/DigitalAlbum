...
export const getAddExpenseSuccess = (successData) => ({ type: ADD_EXPENSE_SUCCESS, payload: successData });
export const getAddExpenseFailure = (failureReport) => ({ type: ADD_EXPENSE_FAILURE, payload: failureReport });
