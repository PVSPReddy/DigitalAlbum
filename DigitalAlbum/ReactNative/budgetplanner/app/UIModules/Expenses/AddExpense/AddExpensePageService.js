import { PostExpenditureURL, mainURL, successStatusCode } from "../../../Constants/URLConstants";
import { getAddExpense, getAddExpenseFailure, getAddExpenseSuccess } from "./AddExpensePageActions";
    ...
    return async dispatchAddExpense => {
        ...
        try {
            ...
            fetch(url, {
                ...
                dispatchAddExpense(getAddExpenseFailure({ errorMessage: "Catch Block triggered for fetch" }));
                console.log(error);
            });
        }
        catch (error) {
            console.log(error);
            dispatchAddExpense(getAddExpenseFailure({ errorMessage: "Catch Block triggered" }));
        }
    }
}